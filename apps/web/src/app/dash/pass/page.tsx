...
function EventPass({ qrPayload, user, clerk, guild }: EventPassProps) {
	return (
		<div className="relative my-20 h-max">
			...
			<div className="flex aspect-[9/17] !max-h-[calc(100vh-7rem)] w-full max-w-[400px] flex-col overflow-hidden rounded-3xl border-2 border-muted star-bg py-[37.5px] dark:border">
