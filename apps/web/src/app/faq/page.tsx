    ...
    <>
        <Navbar />
            <div className="min-h-96 gap-4 bg-[#3B3486] px-2 pb-48 pt-12 font-oswald md:px-10 lg:gap-6">
                ...
                >
                    <div className="mb-8 flex items-center justify-center gap-3 rounded-lg border-4 border-[#E6B84E] bg-[#2F296B] py-4 md:gap-6 lg:col-span-2">
                        <Image
                            ...
                            height={50}
                        />
                        <h1 className="text-center text-4xl font-extrabold text-white sm:text-5xl md:text-7xl">
                            Hackathon FAQ
						</h1>
					</div>
