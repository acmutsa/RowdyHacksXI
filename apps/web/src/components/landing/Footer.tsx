...
export default function Footer() {
	...
	return (
		<>
			<footer className="relative bottom-0 bg-[#3B3486] min-h-[25vh] w-full items-center justify-center border-muted-foreground p-1 py-8 sm:p-8 md:px-10 overflow-hidden">
