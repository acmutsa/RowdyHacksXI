	...
	return (
		<>
			<section className="relative z-0">
				{/* Content of the section above the footer */}
			</section>
			<section className="relative bottom-0 bg-[#3B3486] min-h-[25vh] w-full items-center justify-center border-muted-foreground p-1 py-8 sm:p-8 md:px-10">
				<div className="grid grid-cols-2 gap-y-8 sm:grid-cols-4 md:justify-items-center lg:grid-cols-5 lg:justify-items-start">
					...
					<div className="relative z-0 w-fit gap-y-3 px-5 py-5">
						<CreatedWithHackkit/>
					</div>
				</div>
			</section>
