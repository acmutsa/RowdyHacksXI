...
export default function Footer() {
	return (
		<>
			<footer className="relative bottom-0 min-h-[375px] w-full items-center justify-center overflow-hidden border-muted-foreground bg-[#3B3486] p-1 py-8 sm:p-8 md:px-10">
				<div className="grid grid-cols-2 gap-y-8 sm:grid-cols-4 md:justify-items-center lg:grid-cols-5 lg:justify-items-start">
					...
					<div className="col-span-2 -mt-6 flex w-full items-start justify-between sm:-mt-8 lg:col-span-5">
						{/* HackKit on the left */}
						...
						<div className="flex min-h-[48px] items-center gap-x-2 rounded-lg border-black bg-[#222222] py-[6px] pl-[7px] pr-4">
